...
describe('finds the longest word in the input string', () => {
	...
	it('checks if "helloworld" is the longest word in "abc:def .he~llo;w-orld: /bi#cy!cl^e {c}d|e [f]g hj "k% l $o &p *q( r)t_ v+e- q=t ,zm` v\'"', () => {
		string = 'abc:def .he~llo;w-orld: /bi#cy!cl^e {c}d|e [f]g hj "k% l $o &p *q( r)t_ v+e- q=t ,zm` v\'';
